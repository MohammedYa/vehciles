...
@Component({
  selector: 'app-general-statistics-motorcycle',
  templateUrl: './general-statistics-motorcycle.component.html',
  styleUrl: './general-statistics-motorcycle.component.css'
})
export class GeneralStatisticsMotorcycleComponent {
