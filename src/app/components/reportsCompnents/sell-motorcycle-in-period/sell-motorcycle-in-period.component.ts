...
@Component({
  selector: 'app-sell-motorcycle-in-period',
  templateUrl: './sell-motorcycle-in-period.component.html',
  styleUrl: './sell-motorcycle-in-period.component.css'
})
export class SellMotorcycleInPeriodComponent  implements OnInit{
